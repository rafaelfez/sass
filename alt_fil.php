...
if (isset($_GET['matricula'])) {
    list($matricula, $nome, $telefone, $nascimento, $rg, $cpf, $celular,
      $sexo, $email, $taxa_rcs, $pis, $carteiratrab, $eleitor, $banco, $agencia, $conta, $digito, $civil, $escolaridade, $cnhnum, $cnhtipo, $cnhvalidade, $endcep, $endrua, $endnum, $endbairro, $endcidade, $enduf) = get_filiado(filter_input(INPUT_GET, 'matricula', FILTER_SANITIZE_NUMBER_INT));
}
...
<div class="panel panel-primary">
    ...
    if(empty($matricula) || empty($nome) || empty($nascimento) || empty($celular) ||  empty($email) || empty($rg) || empty($cpf) || empty($taxa_rcs)){
  ...
  echo $message->
        ...
        <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="alt_fil.php">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-sm-4">
              <input class="form-control form-control-success" readonly="true" placeholder="8 digitos" data-error="Por favor, informe um número de matrícula correto." id="matricula" name="matricula" pattern="[0-9]{8}$" required="" type="text" value="<?php echo htmlspecialchars($matricula); ?>"> <span aria-hidden="true" class="glyphicon form-control-feedback"></span>
            </div>
