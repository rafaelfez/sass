...
$afiliado_matricula = $bruto = $mes = $ano = $unimed = $uniodonto = $plano = $valor = $taxa_rcs = $rcs = $das = $descontounimed = $descontouniodonto = $message = '';
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $descontounimed = filter_input(INPUT_POST, 'descontounimed', FILTER_SANITIZE_NUMBER_INT);
  $descontouniodonto = filter_input(INPUT_POST, 'descontouniodonto', FILTER_SANITIZE_NUMBER_INT);
...
?>
  ...
  <form class="pagamento2" method="post" action="pagamento.php">-->
      <div class="form-group has-feedback">
        <label for="bruto" class="col-sm-2 control-label">Salário (R$):<span class="required">*</span>
        </label>
        <div class="col-sm-2">
          <input type="text" class="form-control" id="bruto" name="bruto" data-error="Por favor, informe um valor correto." pattern="^[0-9]+(\.[0-9]{1,2})?$" required value="<?php echo htmlspecialchars($bruto); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
        </div>
        <div class="help-block with-errors">
        </div>
      </div>
      ...
      <div class="form-group has-feedback">
        <label for="descontounimed" class="col-sm-2 control-label">Desconto:<span class="required">*</span>
        </label>
        <div class="col-sm-2">
      ...
      <div class="form-group has-feedback">
        <label for="descontouniodonto" class="col-sm-2 control-label">Desconto:<span class="required">*</span>
        </label>
        <div class="col-sm-2">
