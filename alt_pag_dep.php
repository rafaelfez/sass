...
if (isset($_GET['id'])) {
    list($afiliado_matricula, $ano, $mes, $unimed, $uniodonto, $id) = get_pagamentos_dep(filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT));
}
...
?>
  ...
  <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="alt_pag_dep.php">
