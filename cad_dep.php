...
if(empty($afiliado_matricula) || empty($nome) || empty($telefone) || empty($nascimento) || empty($endereco) || empty($rg) || empty($cpf) || empty($celular) || empty($sexo) || empty($email) || empty($parentesco)){
    ...
    if(add_dep($afiliado_matricula,$nome,$telefone,$nascimento,$endereco,$rg,$cpf,$celular,$email,$sexo,$parentesco)){
     $message = mesSucesso("Dependente cadastrado com sucesso!");
     //Limpa o formulário
        ...
        <form class="form-horizontal" data-toggle="validator" method="post" role="form" action="cad_dep.php">
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-2">
                    <input type="text" required class="form-control form-control-success" id="afiliado_matricula" name="afiliado_matricula" data-error="Por favor, informe um número de matrícula correto." pattern="[0-9]{5}$" value="<?php echo htmlspecialchars($afiliado_matricula); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-4">
                    <input type="text" required placeholder="" class="form-control" id="nome" name="nome" data-error="Por favor, informe um nome correto." value="<?php echo htmlspecialchars($nome); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-2">
                    ...
                    <input type="text" required pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" placeholder="dd/mm/aaaa" class="form-control datepicker" id="nascimento" name="nascimento" data-error="Por favor, informe uma data de nascimento correta." value="<?php echo htmlspecialchars($nascimento);?>"/>
       ...
       <span class="glyphicon form-control-feedback" >
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-2">
                    <select id="sexo" class="form-control" name="sexo" data-error="Por favor, selecione o sexo." required>
                        <option value="">
                        Selecione: </option>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <abbr title="Cadastrar Dependente">
