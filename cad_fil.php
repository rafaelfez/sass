...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-4">
          <input class="form-control form-control-success" placeholder="8 dígitos..." data-error="Por favor, informe um número de matrícula correto." id="matricula" name="matricula" pattern="[0-9]{8}$" required="" type="text" value="<?php echo htmlspecialchars($matricula); ?>"> <span aria-hidden="true" class="glyphicon form-control-feedback"></span>
        </div>
  ...
  <div class="panel-body">
      ...
      <div class="form-group has-feedback">
        ...
        * </span>
        ...
        <div class="col-sm-4">
          <input type="text" required pattern="[0-9]{5,15}$" placeholder="Digite somente os números..." class="form-control" id="conta" name="conta" data-error="Por favor, informe um número de conta válido." data-min-length=7 value="<?php echo htmlspecialchars($conta); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
          </span>
        </div>
        <div class="help-block with-errors">
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <abrr title="Cadastrar Filiado"><input class="btn btn-primary" type="submit" name="cadastrar" value="Cadastrar"/></abrr>
