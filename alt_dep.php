...
if (isset($_GET['cpf'])) {
    list($cpf, $nome, $telefone, $email, $endereco, $rg, $celular, $sexo, $afiliado_matricula, $parentesco, $nascimento) = get_dependente(filter_input(INPUT_GET, 'cpf', FILTER_SANITIZE_NUMBER_INT));
}
...
if(empty($afiliado_matricula) || empty($nome) || empty($telefone) || empty($nascimento) || empty($endereco) || empty($rg) || empty($cpf) || empty($celular) || empty($sexo) || empty($email) || empty($parentesco)){
    ...
    if(alterarDependente($afiliado_matricula,$nome,$telefone,$nascimento,$endereco,$rg,$cpf,$celular,$email,$sexo,$parentesco)){
      mesSucesso("Dados do Dependente alterados com sucesso!");
    }else{
  ...
  echo $message->
        ...
        <form class="form-horizontal" data-toggle="validator" method="post" role="form" action="alt_dep.php">
            ...
            <div class="form-group has-feedback">
                ...
                Matrícula do Arrumador: <span class="required">
                * </span>
                </label>
                <div class="col-sm-2">
                    <input type="text" class="form-control form-control-success" id="afiliado_matricula" name="afiliado_matricula" data-error="Por favor, informe um número de matrícula correto." pattern="[0-9]{5}$" required value="<?php echo htmlspecialchars($afiliado_matricula); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="nome" name="nome" data-error="Por favor, informe um nome correto." required value="<?php echo htmlspecialchars($nome); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-2">
                    <input data-provide="datepicker" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" placeholder="dd/mm/aaaa" class="form-control datepicker" id="nascimento" name="nascimento" data-error="Por favor, informe uma data de nascimento correta." required value="<?php echo htmlspecialchars($nascimento); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-2">
                    <select class="form-control" id="sexo" name="sexo" data-error="Por favor, selecione o sexo." required>
                        <option value="">
                        Selecione um: </option>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-3">
                    <input type="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="" class="form-control" id="email" name="email" data-error="Por favor, informe um e-mail válido." value="<?php echo htmlspecialchars($email); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                * </span>
                ...
                <div class="col-sm-3">
                    <input ttype="text" required pattern="[0-9]{11}$" placeholder="Digite somente os números..." class="form-control" id="cpf" name="cpf" data-error="Por favor, informe um número de CPF válido." value="<?php echo htmlspecialchars($cpf); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
            ...
            <div class="form-group has-feedback">
                ...
                Endereço: <span class="required">
                * </span>
                </label>
                <div class="col-sm-3">
                    <input type="text" required placeholder="" class="form-control" id="endereco" name="endereco" data-error="Por favor, informe um nome de logradouro." value="<?php echo htmlspecialchars($endereco); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
            ...
            <div class="form-group has-feedback">
                <label for="parentesco" class="col-sm-2 control-label">
                Parentesco: <span class="required">
                * </span>
                </label>
                <div class="col-sm-3">
                    <input type="text" required data-error="Por favor, informe parentesco do dependente." placeholder="" class="form-control" id="parentesco" name="parentesco" value="<?php echo htmlspecialchars($parentesco); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                </div>
                <div class="help-block with-errors">
                </div>
