...
if(empty($afiliado_matricula)||empty($mes)||empty($ano)||empty($decimoterceiro)||empty($refeicao)||empty($ferias)){
    ...
    if(encargo($afiliado_matricula, $mes, $ano, $decimoterceiro, $refeicao, $ferias)){
      mesSucesso("Encargos sociais registrados");
    }else{
...
?>
  ...
  <div class="panel-heading">
    <h2 class="panel-title"><big>Encargos Sociais</big></h2>
  </div>
  <div class="panel-body">

  <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="encargos.php">
        ...
        <div class="col-sm-2">
        <input type="text" class="form-control" id="decimoterceiro" name="decimoterceiro" data-error="Por favor, informe um valor correto." required value="<?php echo htmlspecialchars($decimoterceiro); ?>"/>
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
              </div>
              <div class="help-block with-errors"></div>
            </div>
        ...
        <div class="form-group has-feedback">    
          ...
          <div class="col-sm-2">
          <input type="text" class="form-control" id="refeicao" name="refeicao" data-error="Por favor, informe um valor correto." required value="<?php echo htmlspecialchars($refeicao); ?>"/>
          <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
          </div>
              <div class="help-block with-errors"></div>
            </div>
        ...
        <div class="col-sm-2">
        <input type="text" class="form-control" id="ferias" name="ferias" data-error="Por favor, informe um valor correto." required value="<?php echo htmlspecialchars($ferias); ?>"/>
          <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
          </div>
              <div class="help-block with-errors"></div>
            </div>
