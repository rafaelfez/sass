...
$afiliado_matricula = $mes = $ano = $adicional = $message ='';
...
?>
  <div class="panel panel-primary">
    <div class="panel-heading">
        ...
        <big>
        Pagamento de Fluxo Adicional </big>
        </h2>
    </div>
  ...
  if(empty($afiliado_matricula)||empty($mes)||empty($ano)||empty($adicional)){
    ...
    $message = mesSucesso("Adicional registrado com sucesso!");
        ...
        getMessage(); exit;} if(isset($message)){ echo $message; } ?>
            ...
            <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="adicional.php">
                ...
                <div class="form-group has-feedback">
                    <label for="Afiliado_matricula" class="col-sm-2 control-label">
                        Matrícula: <span class="required">
                * </span>
                    </label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control form-control-success" id="Afiliado_matricula" name="Afiliado_matricula" data-error="Por favor, informe um número de matrícula correto." pattern="[0-9]{5,7}$" required value="<?php echo htmlspecialchars($afiliado_matricula); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                    </div>
                ...
                * </span>
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control form-control-success" id="adicional" name="adicional " data-error="Por favor, informe um valor correto." required pattern="^[0-9]+(\.[0-9]{1,2})?$" value="<?php echo htmlspecialchars($adicional); ?>" /> <span class="glyphicon form-control-feedback" aria-hidden="true">
                    </span>
                    </div>
                    <div class="help-block with-errors">
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <abrr title="Concluir Adicional">
                            <input class="btn btn-primary" type="submit" name="registrar" value="Concluir" />
                        </abrr>
                        <abrr title="Cancelar">
